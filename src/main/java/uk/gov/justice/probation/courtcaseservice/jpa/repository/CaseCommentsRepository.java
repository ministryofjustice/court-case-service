...
public interface CaseCommentsRepository extends CrudRepository<CaseCommentEntity, Long> {
    ...
    List<CaseCommentEntity> findByDefendantIdAndDeletedFalseAndDraftFalseAndLegacyFalseAndCreatedBetween(String defendantId, LocalDateTime fromDate, LocalDateTime toDate);
    List<CaseCommentEntity> findByDefendantIdAndDeletedFalseAndDraftFalseAndLegacyFalseAndCreatedAfter(String defendantId, LocalDateTime fromDate);
    List<CaseCommentEntity> findByDefendantIdAndDeletedFalseAndDraftFalseAndLegacyFalseAndCreatedBefore(String defendantId, LocalDateTime toDate);
