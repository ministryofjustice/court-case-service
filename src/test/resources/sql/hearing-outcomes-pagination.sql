...
VALUES (-1710020001, 'ADJOURNED', '2023-4-24 09:09:09', 'IN_PROGRESS', now() - interval '15 days', now(), 'R__case-progress.sql', 'Joe Blogs', '4b03d065-4c96-4b24-8d6d-75a45d2e3f12', -1700028898, -1000110);

INSERT INTO courtcaseservicetest.hearing_outcome(id, outcome_type, outcome_date, state, resulted_date, created, created_by, assigned_to, assigned_to_uuid, fK_hearing_id, fk_hearing_defendant_id)
VALUES (-1710020003, 'ADJOURNED', '2023-4-24 09:09:09', 'IN_PROGRESS', now() - interval '17 days', now(), 'R__case-progress.sql', 'Joe Blogs', '4b03d065-4c96-4b24-8d6d-75a45d2e3f12', -1700028897, -1000111);

INSERT INTO courtcaseservicetest.hearing_outcome(id, outcome_type, outcome_date, state, resulted_date, created, created_by, assigned_to, assigned_to_uuid, fK_hearing_id, fk_hearing_defendant_id)
VALUES (-1710020002, 'ADJOURNED', '2023-4-24 09:09:09', 'IN_PROGRESS', now() - interval '5 days', now(), 'R__case-progress.sql', 'John Smith', '8f69def4-3c52-11ee-be56-0242ac120002', -1700028600, -1000000);
