...
class CourtCaseControllerPutByHearingIdIntTest extends BaseIntTest {
    ...
    void whenCreateCaseByHearingId_thenCreateNewRecord() {
        ...
        given()
                ...
                .body("defendants[0].offences[0].plea.value", equalTo("plea value 1"))
                .body("defendants[0].offences[0].plea.date", equalTo("2023-03-01"))
                .body("defendants[0].offences[0].verdict.typeDescription", equalTo("type 1"))
