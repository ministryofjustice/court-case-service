    ...
    inner class SARContent {
        ...
        fun `should return case comments, hearing outcomes and hearing notes if present for defendant`() {
            RestAssured.given()
                ...
                .body("content.comments[0].author", Matchers.equalTo("One"))
                ...
                .body("content.comments[0].lastUpdatedBy", Matchers.equalTo("LastUpdatedAuthor"))
                ...
                .body("content.comments[1].author", Matchers.equalTo("Three"))
                ...
                .body("content.comments[1].lastUpdatedBy", Matchers.equalTo("LastUpdatedAuthor3"))
                ...
                .body("content.hearingOutcomes[0].state", Matchers.equalTo("In progress"))
                .body("content.hearingOutcomes[0].assignedTo", Matchers.equalTo("Smith"))
                ...
                .body("content.hearingNotes[0].author", Matchers.equalTo("Doe"))
        }
        ...
        fun `should return case comments if present for defendant but no case number if not LIBRA`() {
            RestAssured.given()
                ...
                .body("content.comments[0].author", Matchers.equalTo("Two"))
                ...
                .body("content.comments[0].lastUpdatedBy", Matchers.equalTo("LastUpdatedAuthor2"))
        ...
        fun `should return case comments, hearing outcomes and hearing notes if present for defendant to date`() {
            RestAssured.given()
                ...
                .statusCode(200)
                .body("content.comments[0].comment", Matchers.equalTo("PSR in progress"))
                .body("content.comments[0].author", Matchers.equalTo("Three"))
                ...
                .body("content.comments[0].lastUpdatedBy", Matchers.equalTo("LastUpdatedAuthor3"))
                .body("content.comments[0].caseNumber", Matchers.equalTo("1600028888"))
                .body("content.hearingOutcomes[0].outcomeType", Matchers.equalTo("Adjourned"))
                .body("content.hearingOutcomes[0].outcomeDate", Matchers.equalTo("2023-04-24T09:09:09"))
                .body("content.hearingOutcomes[0].resultedDate", Matchers.equalTo("2023-04-25T09:09:09"))
