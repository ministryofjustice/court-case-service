...
public class ConvictionService {
    ...
    private SentenceResponse combineOffenderAndConvictions(List<AttendanceResponse> attendanceResponses, Conviction conviction, SentenceStatus sentenceStatus, CommunityApiOffenderResponse offenderDetail) {        var builder = SentenceResponse.builder()
                ...
                .links(SentenceLinks.builder()
                        ...
                        .build())
                .sentenceId(sentenceStatus.sentenceId())
                .sentenceDescription(sentenceStatus.sentenceDescription())
                .mainOffenceDescription(sentenceStatus.mainOffenceDescription())
                .sentenceDate(sentenceStatus.sentenceDate())
                .actualReleaseDate(sentenceStatus.actualReleaseDate())
                .length(sentenceStatus.length())
                .lengthUnits(sentenceStatus.lengthUnits())
                .custody(CustodyDetail.builder()
                    .custodialType(sentenceStatus.custodialType())
                    .licenceExpiryDate(sentenceStatus.licenceExpiryDate())
                    .pssEndDate(sentenceStatus.pssEndDate())
                    .build());
