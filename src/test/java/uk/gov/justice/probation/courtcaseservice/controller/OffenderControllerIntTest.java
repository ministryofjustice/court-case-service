...
class OffenderControllerIntTest extends BaseIntTest {
    ...
    void whenCallMadeToGetProbationRecord_thenReturnCorrectData() {
        ...
        .then()
                ...
                .body("convictions[0].awaitingPsr", equalTo(true))
                ...
                .body("convictions[0].psrReports", hasSize(1))
                .body("convictions[0].psrReports[0].requestedDate", equalTo(standardDateOf(2012, 10,16)))
                .body("convictions[0].psrReports[0].requiredDate", equalTo(standardDateOf(2012, 10,23)))
                .body("convictions[0].psrReports[0].completedDate", equalTo(standardDateOf(2012, 10,22)))
                .body("convictions[0].psrReports[0].courtReportType.code", equalTo("CJF"))
                .body("convictions[0].psrReports[0].courtReportType.description", equalTo("Pre-Sentence Report - Fast"))
                .body("convictions[0].psrReports[0].author.unallocated", equalTo(true))
                ...
                .body("convictions[0].psrReports[0].deliveredCourtReportType.code", equalTo("PSR"))
                .body("convictions[0].psrReports[0].deliveredCourtReportType.description", equalTo("Pre-Sentence Report"))
                ...
                .body("convictions[1].awaitingPsr", equalTo(false))
