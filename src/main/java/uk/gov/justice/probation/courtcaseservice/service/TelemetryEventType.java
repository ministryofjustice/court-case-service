...
public enum TelemetryEventType {
    ...
    HEARING_OUTCOME_CREATED("PicHearingOutcomeCreated"),
    HEARING_OUTCOME_UPDATED("PicHearingOutcomeUpdated"),
    CASE_RESULT_CREATED("PicCaseResultCreated"),
    CASE_RESULT_UPDATED("PicCaseResultUpdated"),
