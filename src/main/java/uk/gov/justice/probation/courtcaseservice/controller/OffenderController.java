...
public class OffenderController {
    ...
    @Autowired
    private OffenderResponseMapper responseMapper;

    @GetMapping(path="offender/{crn}/probation-record", produces = APPLICATION_JSON_VALUE)
    public @ResponseBody OffenderResponse getOffender(String crn) {
        return responseMapper.mapFrom(offenderService.getOffender(crn));
    }
}
