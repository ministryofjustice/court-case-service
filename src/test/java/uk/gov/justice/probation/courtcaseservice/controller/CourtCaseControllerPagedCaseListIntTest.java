...
public class CourtCaseControllerPagedCaseListIntTest extends BaseIntTest {
    ...
    void GET_cases_givenNoCreatedFilterParams_whenGetCases_thenReturnAllCases() {
        ...
        given()
            ...
            .body("cases.find { it.hearingId == '4a7220b8-88bc-4417-8ee0-cfc318047b3c' }.caseId", equalTo("665597e6-b4d0-466d-98ad-3a9e9eb99b87"))

            .body("cases.find { it.hearingId == '1eb3a6da-8189-4de2-8377-da5910e486b9' }.hearingId", equalTo("1eb3a6da-8189-4de2-8377-da5910e486b9"))
            .body("cases.find { it.hearingId == '1eb3a6da-8189-4de2-8377-da5910e486b9' }.session", equalTo("MORNING"))
            .body("cases.find { it.hearingId == '1eb3a6da-8189-4de2-8377-da5910e486b9' }.defendantType", equalTo("PERSON"))
            .body("cases.find { it.hearingId == '1eb3a6da-8189-4de2-8377-da5910e486b9' }.defendantName", equalTo("Mr Jeff Blogs"))
            .body("cases.find { it.hearingId == '1eb3a6da-8189-4de2-8377-da5910e486b9' }.defendantId", equalTo("8dc4322f-75de-429b-875b-0063b7c0c044"))
            .body("cases.find { it.hearingId == '1eb3a6da-8189-4de2-8377-da5910e486b9' }.probationStatus", equalTo(POSSIBLE_NDELIUS_RECORD_PROBATION_STATUS))
            .body("cases.find { it.hearingId == '1eb3a6da-8189-4de2-8377-da5910e486b9' }.crn", equalTo(null))
            .body("cases.find { it.hearingId == '1eb3a6da-8189-4de2-8377-da5910e486b9' }.offences[0].offenceSummary", equalTo("On 01/01/2016 at Town, stole Article, to the value of £100.00, belonging to Person."))
            .body("cases.find { it.hearingId == '1eb3a6da-8189-4de2-8377-da5910e486b9' }.offences[0].offenceTitle", equalTo("Offence 102"))
            .body("cases.find { it.hearingId == '1eb3a6da-8189-4de2-8377-da5910e486b9' }.offences[0].act", equalTo("Contrary to section 1(1) and 7 of the Theft Act 1968."))
            .body("cases.find { it.hearingId == '1eb3a6da-8189-4de2-8377-da5910e486b9' }.offences[0].listNo", equalTo(null))
