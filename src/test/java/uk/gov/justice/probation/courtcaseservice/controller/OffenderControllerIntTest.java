...
class OffenderControllerIntTest extends BaseIntTest {
    ...
    void whenCallMadeToGetProbationRecord_thenReturnCorrectData() {
        ...
        .then()
                ...
                .body("convictions[0].licenceConditions", hasSize(0))
                ...
                .body("convictions[1].requirements", hasSize(2))
                .body("convictions[1].requirements[0].requirementId", equalTo(2500083652L))
                .body("convictions[1].requirements[0].startDate", equalTo(standardDateOf(2017, 6,1)))
                .body("convictions[1].requirements[0].terminationDate", equalTo(standardDateOf(2017, 12, 1)))
                .body("convictions[1].requirements[0].expectedStartDate", equalTo(standardDateOf(2017, 6,1)))
                .body("convictions[1].requirements[0].expectedEndDate", equalTo(standardDateOf(2017, 12, 1)))
                .body("convictions[1].requirements[0].active", is(false))
                .body("convictions[1].requirements[0].requirementTypeSubCategory.code",  equalTo("W01"))
                .body("convictions[1].requirements[0].requirementTypeSubCategory.description", equalTo("Regular"))
                .body("convictions[1].requirements[0].requirementTypeMainCategory.code",  equalTo("W"))
                .body("convictions[1].requirements[0].requirementTypeMainCategory.description", equalTo("Unpaid Work"))
                .body("convictions[1].requirements[0].terminationReason.code",  equalTo("74"))
                .body("convictions[1].requirements[0].terminationReason.description", equalTo("Hours Completed Outside 12 months (UPW only)"))
                .body("convictions[1].requirements[0].length", equalTo(60))
                .body("convictions[1].requirements[0].lengthUnit", equalTo("Hours"))
                .body("convictions[1].requirements[1].requirementId",  equalTo(2500007925L))
                .body("convictions[1].requirements[1].startDate", equalTo(standardDateOf(2015, 7,1)))
                .body("convictions[1].requirements[1].commencementDate", equalTo(standardDateOf(2015, 6,29)))
                .body("convictions[1].requirements[1].active", is(true))
                .body("convictions[1].requirements[1].adRequirementTypeMainCategory.code",  equalTo("7"))
                .body("convictions[1].requirements[1].adRequirementTypeMainCategory.description", equalTo("Court - Accredited Programme"))
                .body("convictions[1].requirements[1].adRequirementTypeSubCategory.code",  equalTo("P12"))
                .body("convictions[1].requirements[1].adRequirementTypeSubCategory.description", equalTo("ASRO"))
                .body("convictions[1].pssRequirements", hasSize(0))
                .body("convictions[1].licenceConditions", hasSize(2))
