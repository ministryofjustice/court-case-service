...
ALTER TABLE OFFENCE ADD COLUMN CASE_NO TEXT;
ALTER TABLE OFFENCE ADD COLUMN COURT_CODE TEXT;

DELETE FROM OFFENCE WHERE ID > 1;
COMMIT;

ALTER TABLE OFFENCE ALTER COLUMN CASE_NO SET NOT NULL;
ALTER TABLE OFFENCE ALTER COLUMN COURT_CODE SET NOT NULL;
