...
class AttendanceMapperTest {
    ...
    void mapNullAttendances() {
        ...
        // Act
        final AttendancesResponse response = mapper.attendancesFrom(apiAttendances, CRN, SOME_CONVICTION_ID);
    ...
    void mapMultipleAttendances() {
        ...
        assertThat(response.getCrn()).isEqualTo(CRN);
        assertThat(response.getConvictionId()).isEqualTo(SOME_CONVICTION_ID);
        assertThat(response.getAttendances()).doesNotHaveDuplicates();
        ...
        assertThat(response.getAttendances()).filteredOn("contactId", SOME_CONTACT_ID_1).first().isEqualTo(expectedResponse1);
        ...
        assertThat(response.getAttendances()).filteredOn("contactId", SOME_CONTACT_ID_2).first().isEqualTo(expectedResponse2);
    }
}
