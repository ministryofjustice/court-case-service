...
public class OffenderMapperTest {
    ...
    @Test
    public void WIP_shouldMapConvictionDetailsToConviction() {
        ...
        assertThat(conviction1.getEndDate()).isEqualTo(LocalDate.of(2019,9,16));

        Conviction conviction2 = convictions.get(1);
        assertThat(conviction2.getConvictionId()).isEqualTo("2500295345");
        assertThat(conviction2.getSentence().getDescription()).isEqualTo("Arson - 05600");

        Conviction conviction3 = convictions.get(2);
        assertThat(conviction3.getConvictionId()).isEqualTo("2500295343");
        assertThat(conviction3.getSentence().getDescription()).isEqualTo("Arson - 05600");
