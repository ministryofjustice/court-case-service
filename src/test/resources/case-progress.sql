...
INSERT INTO courtcaseservicetest.hearing_outcome(id, outcome_type, outcome_date, state, created, created_by)
VALUES (-1700020002, 'ADJOURNED', '2023-4-24 09:09:09', 'NEW', now(), 'case-progress.sql');

INSERT INTO courtcaseservicetest.hearing_outcome(id, outcome_type, outcome_date, state, created, created_by)
VALUES (-1700020003, 'ADJOURNED', '2023-4-24 09:09:09', 'NEW', now(), 'case-progress.sql');
...
VALUES (-1700020004, 'ADJOURNED', '2023-4-24 09:09:09', 'IN_PROGRESS', now(), 'case-progress.sql', 'John Smith', '8f69def4-3c52-11ee-be56-0242ac120002');
...
INSERT INTO courtcaseservicetest.hearing (id, fk_court_case_id, hearing_id, hearing_type, created, fk_hearing_outcome) VALUES (-1700028899, -1700028600, '96e3958e-3c21-11ee-be56-0242ac120002', 'Hearing', TO_TIMESTAMP('2019-10-14 9:00:00', 'YYYY-MM-DD HH:MI:SS'), -1700020003);
INSERT INTO courtcaseservicetest.hearing (id, fk_court_case_id, hearing_id, hearing_type, created, fk_hearing_outcome) VALUES (-1700028900, -1700028600, 'ead45e2c-3c39-11ee-be56-0242ac120002', 'Hearing', TO_TIMESTAMP('2019-10-14 9:00:00', 'YYYY-MM-DD HH:MI:SS'), -1700020004);
...
INSERT INTO courtcaseservicetest.HEARING_DAY (id, fk_hearing_id, court_code, court_room, hearing_day, hearing_time)
VALUES (-1000003, -1700028900, 'B33HU', 1, '2019-10-14', '09:00');
...
INSERT INTO courtcaseservicetest.HEARING_DEFENDANT(id, fk_hearing_id, DEFENDANT_ID, FK_DEFENDANT_ID)
VALUES (-1000210, -1700028900, '40db17d6-04db-11ec-b2d8-0242ac130002', -1000000);
