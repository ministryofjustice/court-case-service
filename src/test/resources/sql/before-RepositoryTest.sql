...
INSERT INTO courtcaseservicetest.DEFENDANT (id, DEFENDANT_ID, defendant_name, name, address, type, date_of_birth, crn, pnc, cro, sex, nationality_1, nationality_2, created)
