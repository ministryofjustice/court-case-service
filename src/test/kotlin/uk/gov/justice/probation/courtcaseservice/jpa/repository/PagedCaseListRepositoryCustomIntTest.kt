...
class PagedCaseListRepositoryCustomIntTest {
  ...
  fun shouldReturnUnHeardCasesCorrectly() {
    ...
    assertThat(page1.content.map { it.first.hearing.hearingId }.sorted()).isEqualTo(
      listOf(
  ...
  internal class TestConfig {
    @Bean
    fun pagedCaseListRepositoryCustom(entityManager: EntityManager): PagedCaseListRepositoryCustom = PagedCaseListRepositoryCustom(entityManager)
  }
}
