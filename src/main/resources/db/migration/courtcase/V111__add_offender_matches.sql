BEGIN;
create table offender_match (id int8 generated by default as identity, confirmed boolean not null, crn varchar(255) not null, cro varchar(255), match_type varchar(255), pnc varchar(255), primary key (id));
