    ...
    class GetCasesCaseNo {
        ...
        void GET_cases_givenNoCreatedFilterParams_whenGetCases_thenReturnAllCases() {
            ...
            given()
                    ...
                    .body("cases[0].offences[1].offenceCode", equalTo("RT88191"))
        ...
        void GET_cases_givenCommonPlatformSourceFilterParam_whenGetCases_thenReturnMatchedCaseBasedOnDefendantName() {
            ...
            given()
                    ...
                    .oauth2(getToken())
                    .when()
                    .get("/court/{courtCode}/matcher-cases?date={date}&defendantName={defendantName}", COURT_CODE, DECEMBER_14.format(DateTimeFormatter.ISO_DATE), "Ms Emma Radical")
                    .then()
                    .assertThat()
                    .statusCode(200)
                    .body("cases", hasSize(1))
        ...
        void GET_cases_givenCommonPlatformSourceFilterParam_whenGetCases_thenReturnMatchedCaseBasedOnDefendantId() {
            ...
            given()
                    ...
                    .oauth2(getToken())
                    .when()
                    .get("/court/{courtCode}/matcher-cases?date={date}&defendantId={defendantId}", COURT_CODE, DECEMBER_14.format(DateTimeFormatter.ISO_DATE), "7a320a46-037c-481c-ab1e-dbfab62af4d6")
                    .then()
                    .assertThat()
                    .statusCode(200)
                    .body("cases", hasSize(1))
