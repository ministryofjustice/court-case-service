...
class ExtendedHearingRequestResponseTest {
    ...
    void givenFullDefendantWithOffences_whenAsEntity_thenReturn() {
        ...
        assertThat(offences.get(0).getPlea().getValue()).isEqualTo("pleaValue1");
        assertThat(offences.get(1).getHearingDefendant().getDefendant()).isSameAs(defendantEntity);
        assertThat(offences.get(1).getPlea().getValue()).isEqualTo("pleaValue2");
    ...
    void whenOfCourtCase_thenReturn() {
        ...
        assertThat(actual.getDefendants().get(0)).isEqualTo(Defendant.builder()
                ...
                .offences(List.of(OffenceRequestResponse.builder()
                                ...
                                .verdict(Verdict.builder().verdictType(VerdictType.builder().description("type 1").build()).date(LocalDate.now()).build())
    ...
    void givenOffencesWithJudicialResults_whenAsEntity_thenReturn() {
        ...
        assertThat(offences.get(0).getJudicialResults().get(0).getResultText()).isEqualTo("resultText");
                ...
                .hearingDefendants(List.of(HearingDefendantEntity.builder()
                                ...
                                .offences(List.of(OffenceEntity.builder()
                                                ...
                                                .plea(PleaEntity.builder()
                                                        ...
                                                        .date(LocalDate.now())
                                                        .build())
                                                .verdict(VerdictEntity.builder().typeDescription("type 1").date(LocalDate.now()).build())
                                                .build(),
        ...
        return Defendant.builder()
                ...
                .offences(List.of(OffenceRequestResponse.builder()
                                ...
                                .verdict(Verdict.builder()
                                        .verdictType(VerdictType.builder().description("type 1").build())
                                        .date(LocalDate.now())
                                        .build())
                                .build(),
                        OffenceRequestResponse.builder()
